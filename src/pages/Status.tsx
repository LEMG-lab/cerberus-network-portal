  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        ...
        <div className="lg:col-span-1 bg-[var(--card)] border border-[var(--border)] p-6 rounded-[14px] flex flex-col">
             ...
             <div className="space-y-2">
               {recentBlocks.slice(0, 10).map(b => (
                 <div key={b.number} className="flex justify-between text-xs font-mono">
                   <span className="text-[var(--muted)]">#{b.number}</span>
        ...
        {/* RPC Latency History */}
        <div className="lg:col-span-2 bg-[var(--card)] border border-[var(--border)] p-6 rounded-[14px]">
...
function MetricCard({ title, value, icon }: { title: string, value: string, icon: React.ReactNode }) {
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] p-6 rounded-[14px] flex items-center justify-between">
      <div>
