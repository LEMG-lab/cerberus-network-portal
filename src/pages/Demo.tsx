  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="text-center space-y-4 mb-16">
        <h1 className="text-3xl font-light tracking-wider">Operation Simulator</h1>
          ...
          {steps.map((s, i) => {
            ...
            return (
              <div key={i} className={`flex items-start gap-6 transition-all duration-700 ${isActive ? 'opacity-100' : 'opacity-30'}`}>
                ...
                <div className={`bg-[var(--card)] border transition-colors duration-500 rounded-lg p-6 flex-1 ${isCurrent ? 'border-[var(--accent)]/50' : 'border-[var(--border)]'}`}>
